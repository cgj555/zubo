...
CHANNEL_CATEGORIES = {
    ...
    "4K频道": [
        ...
        "欢笑剧场4K","河南卫视4K","爱上4K", "4K乐享超清", "绚影4K", "4K纪实", "4K少儿", "广东综艺4K", "南国都市4K", "4K乐享超清","天翼高清4K", "BesTV4K电影",
    ...
    "数字频道": [
        ...
        "华数军旅剧场", "华数城市剧场", "华数武侠剧场", "华数古装剧场", "华数魅力时尚", "华数少儿动画", "华数动画", "华数爱大剧", "华数爱电影", "iHOT爱喜剧", "iHOT爱科幻", 
